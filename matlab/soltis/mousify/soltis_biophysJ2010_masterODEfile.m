...
YBAR=y(87+45+6+1:87+45+6+36);

y_ecc = y(1:87);  % Ca_j is y(36), Ca_sl is y(37), Ca_cytosol is y(38) MOUSE
y_camDyad = y(87+1:87+15); % MOUSE
...
%PP1_PLB_avail = y(87+45+6+22)./PP1_PLBtot + .0091;  % Active PP1 near PLB
%/ total PP1 conc + basal value RABBIT
PP1_PLB_avail = 1 - y(87+45+6+24)/PP1_PLBtot + 0.081698; % NEW ODEs MOUSE
