...
def init_state_values(**values):
    ...
    # fCaB_SL=0.01452605, fCaB_jct=0.02421991, R=0.8884332,
    ...
    # Mg_Myosin=0.1381982, Ca_SRB=0.002143165, Na_jct_buf=3.539892,
    # Na_SL_buf=0.7720854, Na_jct=8.80329, Na_SL=8.80733, Nai=8.80853,
    ...
    state_ind = dict([("h",(0, Range())), ("j",(1, Range())), ("m",(2,\
        ...
        ("f",(11, Range())), ("fCaB_SL",(12, Range())), ("fCaB_jct",(13,\
        ...
        ("Na_jct_buf",(24, Range())), ("Na_SL_buf",(25, Range())),\
        ("Na_jct",(26, Range())), ("Na_SL",(27, Range())), ("Nai",(28,\
        Range())), ("Ca_Calsequestrin",(29, Range())), ("Ca_SLB_SL",(30,\
        Range())), ("Ca_SLB_jct",(31, Range())), ("Ca_SLHigh_SL",(32,\
        Range())), ("Ca_SLHigh_jct",(33, Range())), ("Ca_SR",(34, Range())),\
        ("Ca_jct",(35, Range())), ("Ca_SL",(36, Range())), ("Cai",(37,\
        Range())), ("V",(38, Range()))])
...
def init_parameter_values(**values):
    ...
    # kon_TroponinC_Ca_Mg_Mg=0.003, Bmax_SL=1.65, Bmax_jct=7.561,
    ...
    init_values = np.array([1.8, 15, 150, 1.381e-10, 96485, 135, 5.4, 1, 140,\
        ...
        1.5e-08, 1.8, 0.341, 0.341, 0.75, 0.75, 0.75, 0.75, 0.89, 0.11, 3,\
        0.00359, 1.3, 12.29, 87.5, 0.000256, 1.57, 9, 0.35, 0.27, 0.89, 0.11,\
        1.6, 0.0005, 2.35, 0.0673, 0.89, 0.11, 0.0002513, 0.45, 2.5, 15, 1,\
        0.5, 0.005, 10, 0.06, 25, 5.348e-06, 1.787, 0.000246, 1.7, 2.6,\
        0.0053114, 0.14, 0.0374, 0.0046, 0.0134, 0.00165, 65, 1.3, 0.03, 100,\
        100, 0.024, 0.14, 0.14, 0.0171, 0.07, 0.14, 0.14, 0.238, 0.00046,\
        5.7e-05, 0.06, 0.0196, 3.2e-05, 0.00333, 34, 13.8, 0.0157, 100, 32.7,\
        2.37, 0.003, 1.65, 7.561, 0.001, 0.0001, 9.5, 5, 1000, 100],\
        dtype=np.float_)
    ...
    param_ind = dict([("Cao", (0, Range())), ("Cli", (1, Range())), ("Clo",\
        ...
        ("Fx_Na_SL", (13, Range())), ("Fx_Na_jct", (14, Range())), ("G_INa",\
        (15, Range())), ("Fx_NaBk_SL", (16, Range())), ("Fx_NaBk_jct", (17,\
        Range())), ("G_NaBk", (18, Range())), ("Fx_NaK_SL", (19, Range())),\
        ("Fx_NaK_jct", (20, Range())), ("H_NaK", (21, Range())),\
        ("I_NaK_max", (22, Range())), ("Km_Ko", (23, Range())), ("Km_Nai",\
        (24, Range())), ("Fx_Ks_SL", (25, Range())), ("Fx_Ks_jct", (26,\
        Range())), ("pKNa", (27, Range())), ("g_Kp", (28, Range())),\
        ("G_tos", (29, Range())), ("G_tof", (30, Range())), ("Fx_Cl_SL", (31,\
        Range())), ("Fx_Cl_jct", (32, Range())), ("G_Cl", (33, Range())),\
        ("Kd_ClCa", (34, Range())), ("G_ClBk", (35, Range())), ("Fx_ICaL_SL",\
        (36, Range())), ("Fx_ICaL_jct", (37, Range())), ("PCa", (38,\
        ...
        ("Fx_NCX_SL", (48, Range())), ("Fx_NCX_jct", (49, Range())), ("HNa",\
        (50, Range())), ("K_mCai", (51, Range())), ("K_mCao", (52, Range())),\
        ("K_mNai", (53, Range())), ("K_mNao", (54, Range())), ("Kd_act", (55,\
        Range())), ("Q10_NCX", (56, Range())), ("V_max_INaCa", (57,\
        Range())), ("eta", (58, Range())), ("ksat", (59, Range())),\
        ("Fx_SLCaP_SL", (60, Range())), ("Fx_SLCaP_jct", (61, Range())),\
        ("H_ICap", (62, Range())), ("Km", (63, Range())), ("Q10_SLCaP", (64,\
        Range())), ("V_maxAF", (65, Range())), ("Fx_CaBk_SL", (66, Range())),\
        ("Fx_CaBk_jct", (67, Range())), ("G_CaBk", (68, Range())),\
        ("EC50_SR", (69, Range())), ("HSR", (70, Range())), ("Max_SR", (71,\
        Range())), ("Min_SR", (72, Range())), ("kiCa", (73, Range())),\
        ("kim", (74, Range())), ("koCa", (75, Range())), ("kom", (76,\
        Range())), ("ks", (77, Range())), ("KSRleak", (78, Range())),\
        ("H_Jpump", (79, Range())), ("Kmf", (80, Range())), ("Kmr", (81,\
        Range())), ("Q10_SRCaP", (82, Range())), ("V_max_Jpump", (83,\
        Range())), ("Bmax_Calsequestrin", (84, Range())), ("Bmax_SLB_SL",\
        (85, Range())), ("Bmax_SLB_jct", (86, Range())), ("Bmax_SLHigh_SL",\
        (87, Range())), ("Bmax_SLHigh_jct", (88, Range())),\
        ("koff_Calsequestrin", (89, Range())), ("koff_SLB", (90, Range())),\
        ("koff_SLHigh", (91, Range())), ("kon_Calsequestrin", (92, Range())),\
        ("kon_SL", (93, Range())), ("Bmax_Calmodulin", (94, Range())),\
        ("Bmax_Myosin_Ca", (95, Range())), ("Bmax_Myosin_Mg", (96, Range())),\
        ("Bmax_SRB", (97, Range())), ("Bmax_TroponinC", (98, Range())),\
        ("Bmax_TroponinC_Ca_Mg_Ca", (99, Range())),\
        ("Bmax_TroponinC_Ca_Mg_Mg", (100, Range())), ("koff_Calmodulin",\
        (101, Range())), ("koff_Myosin_Ca", (102, Range())),\
        ("koff_Myosin_Mg", (103, Range())), ("koff_SRB", (104, Range())),\
        ("koff_TroponinC", (105, Range())), ("koff_TroponinC_Ca_Mg_Ca", (106,\
        Range())), ("koff_TroponinC_Ca_Mg_Mg", (107, Range())),\
        ("kon_Calmodulin", (108, Range())), ("kon_Myosin_Ca", (109,\
        Range())), ("kon_Myosin_Mg", (110, Range())), ("kon_SRB", (111,\
        Range())), ("kon_TroponinC", (112, Range())),\
        ("kon_TroponinC_Ca_Mg_Ca", (113, Range())),\
        ("kon_TroponinC_Ca_Mg_Mg", (114, Range())), ("Bmax_SL", (115,\
        Range())), ("Bmax_jct", (116, Range())), ("koff", (117, Range())),\
        ("kon", (118, Range())), ("stim_amplitude", (119, Range())),\
        ("stim_duration", (120, Range())), ("stim_period", (121, Range())),\
        ("stim_start", (122, Range()))])
...
def state_indices(*states):
    ...
    state_inds = dict([("h", 0), ("j", 1), ("m", 2), ("Xr", 3), ("Xs", 4),\
        ...
        ("d", 10), ("f", 11), ("fCaB_SL", 12), ("fCaB_jct", 13), ("R", 14),\
        ("O", 15), ("I", 16), ("Ca_TroponinC", 17), ("Ca_TroponinC_Ca_Mg",\
        18), ("Mg_TroponinC_Ca_Mg", 19), ("Ca_Calmodulin", 20), ("Ca_Myosin",\
        21), ("Mg_Myosin", 22), ("Ca_SRB", 23), ("Na_jct_buf", 24),\
        ("Na_SL_buf", 25), ("Na_jct", 26), ("Na_SL", 27), ("Nai", 28),\
        ("Ca_Calsequestrin", 29), ("Ca_SLB_SL", 30), ("Ca_SLB_jct", 31),\
        ("Ca_SLHigh_SL", 32), ("Ca_SLHigh_jct", 33), ("Ca_SR", 34),\
        ("Ca_jct", 35), ("Ca_SL", 36), ("Cai", 37), ("V", 38)])
...
def parameter_indices(*params):
    ...
    param_inds = dict([("Cao", 0), ("Cli", 1), ("Clo", 2), ("Cm", 3), ("F",\
        ...
        ("Fx_Na_jct", 14), ("G_INa", 15), ("Fx_NaBk_SL", 16), ("Fx_NaBk_jct",\
        17), ("G_NaBk", 18), ("Fx_NaK_SL", 19), ("Fx_NaK_jct", 20), ("H_NaK",\
        21), ("I_NaK_max", 22), ("Km_Ko", 23), ("Km_Nai", 24), ("Fx_Ks_SL",\
        25), ("Fx_Ks_jct", 26), ("pKNa", 27), ("g_Kp", 28), ("G_tos", 29),\
        ("G_tof", 30), ("Fx_Cl_SL", 31), ("Fx_Cl_jct", 32), ("G_Cl", 33),\
        ("Kd_ClCa", 34), ("G_ClBk", 35), ("Fx_ICaL_SL", 36), ("Fx_ICaL_jct",\
        37), ("PCa", 38), ("PK", 39), ("PNa", 40), ("Q10_CaL", 41),\
        ("gamma_Cai", 42), ("gamma_Cao", 43), ("gamma_Ki", 44), ("gamma_Ko",\
        45), ("gamma_Nai", 46), ("gamma_Nao", 47), ("Fx_NCX_SL", 48),\
        ("Fx_NCX_jct", 49), ("HNa", 50), ("K_mCai", 51), ("K_mCao", 52),\
        ("K_mNai", 53), ("K_mNao", 54), ("Kd_act", 55), ("Q10_NCX", 56),\
        ("V_max_INaCa", 57), ("eta", 58), ("ksat", 59), ("Fx_SLCaP_SL", 60),\
        ("Fx_SLCaP_jct", 61), ("H_ICap", 62), ("Km", 63), ("Q10_SLCaP", 64),\
        ("V_maxAF", 65), ("Fx_CaBk_SL", 66), ("Fx_CaBk_jct", 67), ("G_CaBk",\
        68), ("EC50_SR", 69), ("HSR", 70), ("Max_SR", 71), ("Min_SR", 72),\
        ("kiCa", 73), ("kim", 74), ("koCa", 75), ("kom", 76), ("ks", 77),\
        ("KSRleak", 78), ("H_Jpump", 79), ("Kmf", 80), ("Kmr", 81),\
        ("Q10_SRCaP", 82), ("V_max_Jpump", 83), ("Bmax_Calsequestrin", 84),\
        ("Bmax_SLB_SL", 85), ("Bmax_SLB_jct", 86), ("Bmax_SLHigh_SL", 87),\
        ("Bmax_SLHigh_jct", 88), ("koff_Calsequestrin", 89), ("koff_SLB",\
        90), ("koff_SLHigh", 91), ("kon_Calsequestrin", 92), ("kon_SL", 93),\
        ("Bmax_Calmodulin", 94), ("Bmax_Myosin_Ca", 95), ("Bmax_Myosin_Mg",\
        96), ("Bmax_SRB", 97), ("Bmax_TroponinC", 98),\
        ("Bmax_TroponinC_Ca_Mg_Ca", 99), ("Bmax_TroponinC_Ca_Mg_Mg", 100),\
        ("koff_Calmodulin", 101), ("koff_Myosin_Ca", 102), ("koff_Myosin_Mg",\
        103), ("koff_SRB", 104), ("koff_TroponinC", 105),\
        ("koff_TroponinC_Ca_Mg_Ca", 106), ("koff_TroponinC_Ca_Mg_Mg", 107),\
        ("kon_Calmodulin", 108), ("kon_Myosin_Ca", 109), ("kon_Myosin_Mg",\
        110), ("kon_SRB", 111), ("kon_TroponinC", 112),\
        ("kon_TroponinC_Ca_Mg_Ca", 113), ("kon_TroponinC_Ca_Mg_Mg", 114),\
        ("Bmax_SL", 115), ("Bmax_jct", 116), ("koff", 117), ("kon", 118),\
        ("stim_amplitude", 119), ("stim_duration", 120), ("stim_period",\
        121), ("stim_start", 122)])
...
def monitor_indices(*monitored):
    ...
    monitor_inds = dict([("Vol_Cell", 0), ("Vol_SR", 1), ("Vol_SL", 2),\
        ("Vol_jct", 3), ("Vol_myo", 4), ("openProb", 5), ("i_Na_jct", 6),\
        ("i_Na_SL", 7), ("i_Na", 8), ("alpha_h", 9), ("beta_h", 10),\
        ("alpha_j", 11), ("beta_j", 12), ("alpha_m", 13), ("beta_m", 14),\
        ("i_Nab_jct", 15), ("i_Nab_SL", 16), ("i_Nab", 17), ("sigma", 18),\
        ("f_NaK", 19), ("i_NaK_jct", 20), ("i_NaK_SL", 21), ("i_NaK", 22),\
        ("G_IKr", 23), ("i_Kr", 24), ("Xr_infinity", 25), ("tau_Xr", 26),\
        ("Rr", 27), ("pCa_jct", 28), ("pCa_SL", 29), ("G_Ks_jct", 30),\
        ("G_Ks_SL", 31), ("E_Ks", 32), ("i_Ks_jct", 33), ("i_Ks_SL", 34),\
        ...
        ("i_CaL_Ca_jct", 55), ("i_CaL_Na_jct", 56), ("i_CaL_Ca_SL", 57),\
        ("i_CaL_Na_SL", 58), ("i_CaL_K", 59), ("i_CaL", 60), ("d_infinity",\
        61), ("tau_d", 62), ("f_infinity", 63), ("tau_f", 64), ("fCa_SL",\
        65), ("fCa_jct", 66), ("temp_jct", 67), ("temp_SL", 68), ("Q_NCX",\
        69), ("Ka_SL", 70), ("Ka_jct", 71), ("i_NaCa_jct", 72), ("i_NaCa_SL",\
        73), ("i_NaCa", 74), ("Q_SLCaP", 75), ("i_Cap_jct", 76), ("i_Cap_SL",\
        77), ("i_Cap", 78), ("i_Cab_jct", 79), ("i_Cab_SL", 80), ("i_Cab",\
        81), ("kCaSR", 82), ("koSRCa", 83), ("kiSRCa", 84), ("RI", 85),\
        ("j_rel_SR", 86), ("j_leak_SR", 87), ("Q_SRCaP", 88), ("j_pump_SR",\
        89), ("dCalsequestrin", 90), ("dCa_SLB_SL", 91), ("dCa_SLB_jct", 92),\
        ("dCa_SLHigh_SL", 93), ("dCa_SLHigh_jct", 94), ("dCa_jct_tot_bound",\
        95), ("dCa_SL_tot_bound", 96), ("i_Ca_jct_tot", 97), ("i_Ca_SL_tot",\
        98), ("dCa_TroponinC", 99), ("dCa_TroponinC_Ca_Mg", 100),\
        ("dMg_TroponinC_Ca_Mg", 101), ("dCa_Calmodulin", 102), ("dCa_Myosin",\
        103), ("dMg_Myosin", 104), ("dCa_SRB", 105),\
        ("dCa_cytosol_tot_bound", 106), ("dNa_jct_buf", 107), ("dNa_SL_buf",\
        108), ("i_Stim", 109), ("E_Na_jct", 110), ("E_Na_SL", 111),\
        ("E_Ca_jct", 112), ("E_Ca_SL", 113), ("E_K", 114), ("E_Cl", 115),\
        ("G_K1", 116), ("i_K1", 117), ("alpha_K1", 118), ("beta_K1", 119),\
        ("K1_infinity", 120), ("J_Na_jct_SL", 121), ("J_Na_SL_myo", 122),\
        ("J_Ca_jct_SL", 123), ("J_Ca_SL_myo", 124), ("dh_dt", 125), ("dj_dt",\
        126), ("dm_dt", 127), ("dXr_dt", 128), ("dXs_dt", 129), ("dX_tos_dt",\
        130), ("dY_tos_dt", 131), ("dR_tos_dt", 132), ("dX_tof_dt", 133),\
        ("dY_tof_dt", 134), ("dd_dt", 135), ("df_dt", 136), ("dfCaB_SL_dt",\
        137), ("dfCaB_jct_dt", 138), ("dR_dt", 139), ("dO_dt", 140),\
        ("dI_dt", 141), ("dCa_TroponinC_dt", 142), ("dCa_TroponinC_Ca_Mg_dt",\
        143), ("dMg_TroponinC_Ca_Mg_dt", 144), ("dCa_Calmodulin_dt", 145),\
        ("dCa_Myosin_dt", 146), ("dMg_Myosin_dt", 147), ("dCa_SRB_dt", 148),\
        ("dNa_jct_buf_dt", 149), ("dNa_SL_buf_dt", 150), ("dNa_jct_dt", 151),\
        ("dNa_SL_dt", 152), ("dNai_dt", 153), ("dCa_Calsequestrin_dt", 154),\
        ("dCa_SLB_SL_dt", 155), ("dCa_SLB_jct_dt", 156), ("dCa_SLHigh_SL_dt",\
        157), ("dCa_SLHigh_jct_dt", 158), ("dCa_SR_dt", 159), ("dCa_jct_dt",\
...
def rhs(states, t, parameters, values=None):
    ...
    h, j, m, Xr, Xs, X_tos, Y_tos, R_tos, X_tof, Y_tof, d, f, fCaB_SL,\
        fCaB_jct, R, O, I, Ca_TroponinC, Ca_TroponinC_Ca_Mg,\
        Mg_TroponinC_Ca_Mg, Ca_Calmodulin, Ca_Myosin, Mg_Myosin, Ca_SRB,\
        Na_jct_buf, Na_SL_buf, Na_jct, Na_SL, Nai, Ca_Calsequestrin,\
        Ca_SLB_SL, Ca_SLB_jct, Ca_SLHigh_SL, Ca_SLHigh_jct, Ca_SR, Ca_jct,\
        Ca_SL, Cai, V = states
    ...
    Cao, Cli, Clo, Cm, F, Ki, Ko, Mgi, Nao, Rgas, T, cell_length,\
        ...
        K_mNai, K_mNao, Kd_act, Q10_NCX, V_max_INaCa, eta, ksat, Fx_SLCaP_SL,\
        Fx_SLCaP_jct, H_ICap, Km, Q10_SLCaP, V_maxAF, Fx_CaBk_SL,\
        Fx_CaBk_jct, G_CaBk, EC50_SR, HSR, Max_SR, Min_SR, kiCa, kim, koCa,\
        kom, ks, KSRleak, H_Jpump, Kmf, Kmr, Q10_SRCaP, V_max_Jpump,\
    ...
    Cao, Cli, Clo, Cm, F, Ki, Ko, Mgi, Nao, Rgas, T, cell_length, cell_radius, Fx_Na_SL, Fx_Na_jct, G_INa, Fx_NaBk_SL, Fx_NaBk_jct, G_NaBk, Fx_NaK_SL, Fx_NaK_jct, H_NaK, I_NaK_max, Km_Ko, Km_Nai, Fx_Ks_SL, Fx_Ks_jct, pKNa, g_Kp, G_tos, G_tof, Fx_Cl_SL, Fx_Cl_jct, G_Cl, Kd_ClCa, G_ClBk, Fx_ICaL_SL, Fx_ICaL_jct, PCa, PK, PNa, Q10_CaL, gamma_Cai, gamma_Cao, gamma_Ki, gamma_Ko, gamma_Nai, gamma_Nao, Fx_NCX_SL, Fx_NCX_jct, HNa, K_mCai, K_mCao, K_mNai, K_mNao, Kd_act, Q10_NCX, V_max_INaCa, eta, ksat, Fx_SLCaP_SL, Fx_SLCaP_jct, H_ICap, Km, Q10_SLCaP, V_maxAF, Fx_CaBk_SL, Fx_CaBk_jct, G_CaBk, EC50_SR, HSR, Max_SR, Min_SR, kiCa, kim, koCa, kom, ks, KSRleak, H_Jpump, Kmf, Kmr, Q10_SRCaP, V_max_Jpump, Bmax_Calsequestrin, Bmax_SLB_SL, Bmax_SLB_jct, Bmax_SLHigh_SL, Bmax_SLHigh_jct, koff_Calsequestrin, koff_SLB, koff_SLHigh, kon_Calsequestrin, kon_SL, Bmax_Calmodulin, Bmax_Myosin_Ca, Bmax_Myosin_Mg, Bmax_SRB, Bmax_TroponinC, Bmax_TroponinC_Ca_Mg_Ca, Bmax_TroponinC_Ca_Mg_Mg, koff_Calmodulin, koff_Myosin_Ca, koff_Myosin_Mg, koff_SRB, koff_TroponinC, koff_TroponinC_Ca_Mg_Ca, koff_TroponinC_Ca_Mg_Mg, kon_Calmodulin, kon_Myosin_Ca, kon_Myosin_Mg, kon_SRB, kon_TroponinC, kon_TroponinC_Ca_Mg_Ca, kon_TroponinC_Ca_Mg_Mg, Bmax_SL, Bmax_jct, koff, kon, stim_amplitude, stim_duration, stim_period, stim_start = parameters
    #print parameters[75]
    ...
    E_Ca_jct = Rgas*T*math.log(Cao/Ca_jct)/(2*F)
    ...
    openProb = (m*m*m)*h*j
    i_Na_jct = Fx_Na_jct*G_INa*(V - E_Na_jct)*openProb
    ...
    i_NaK_jct = Fx_NaK_jct*I_NaK_max*Ko*f_NaK/((1 + math.pow(Km_Nai/Na_jct,\
        H_NaK))*(Km_Ko + Ko))
    i_NaK_SL = Fx_NaK_SL*I_NaK_max*Ko*f_NaK/((1 + math.pow(Km_Nai/Na_SL,\
        H_NaK))*(Km_Ko + Ko))
    i_NaK = i_NaK_SL + i_NaK_jct
    ...
    #print values[8],   -X_tof , X_tof_infinity, tau_X_tof
    ...
    i_Cl_Ca = G_Cl*(Fx_Cl_jct/(1 + Kd_ClCa/Ca_jct) + Fx_Cl_SL/(1 +\
        Kd_ClCa/Ca_SL))*(V - E_Cl)
    ...
    values[13] = -0.0119*fCaB_jct + 1.7*(1 - fCaB_jct)*Ca_jct

    # Expressions for the INaCa component
    temp_jct = (-math.pow(Nao, HNa)*Ca_jct*math.exp(F*(-1 + eta)*V/(Rgas*T))\
        + Cao*math.pow(Na_jct, HNa)*math.exp(F*eta*V/(Rgas*T)))/(1 +\
    ...
    Ka_jct = 1.0/(1 + (Kd_act*Kd_act*Kd_act)/(Ca_jct*Ca_jct*Ca_jct))
    i_NaCa_jct = Fx_NCX_jct*V_max_INaCa*Ka_jct*Q_NCX*temp_jct/(math.pow(Nao,\
        HNa)*Ca_jct + Cao*math.pow(Na_jct, HNa) + K_mCai*math.pow(Nao,\
        HNa)*(1 + math.pow(Na_jct/K_mNai, HNa)) + math.pow(K_mNao, HNa)*(1 +\
        Ca_jct/K_mCai)*Ca_jct + K_mCao*math.pow(Na_jct, HNa))
    ...
    i_NaCa = i_NaCa_SL + i_NaCa_jct

    # Expressions for the ICap component
    Q_SLCaP = math.pow(Q10_SLCaP, -31 + T/10.)
    i_Cap_jct = Fx_SLCaP_jct*V_maxAF*Q_SLCaP/(1 + math.pow(Km/Ca_jct, H_ICap))
    ...
    i_Cab_jct = Fx_CaBk_jct*G_CaBk*(-E_Ca_jct + V)
    ...
    kiSRCa = kiCa*kCaSR
    RI = 1 - I - O - R
    values[14] = -Ca_jct*R*kiSRCa - (Ca_jct*Ca_jct)*R*koSRCa + kom*O + kim*RI
    values[15] = kim*I - Ca_jct*O*kiSRCa + (Ca_jct*Ca_jct)*R*koSRCa - kom*O
    values[16] = -kim*I + (Ca_jct*Ca_jct)*RI*koSRCa + Ca_jct*O*kiSRCa - kom*I
    j_rel_SR = ks*(Ca_SR - Ca_jct)*O
    ...
    J_Ca_jct_SL = 8.2413e-13*Ca_jct - 8.2413e-13*Ca_SL
    ...
    #print Bmax_SRB,Ca_SRB, Cai,kon_SRB,  Ca_SRB,koff_SRB
    #print "---",dCa_SRB; 
    ...
    i_CaL_Ca_jct = 4*Fx_ICaL_jct*PCa*(-Cao*gamma_Cao +\
        gamma_Cai*Ca_jct*math.exp(2*F*V/(Rgas*T)))*fCa_jct*temp/(-1 +\
        math.exp(2*F*V/(Rgas*T)))
    i_CaL_Na_jct = Fx_ICaL_jct*PNa*(-Nao*gamma_Nao +\
        gamma_Nai*Na_jct*math.exp(F*V/(Rgas*T)))*fCa_jct*temp/(-1 +\
        math.exp(F*V/(Rgas*T)))
    ...
    i_CaL_Na_SL = Fx_ICaL_SL*PNa*(-Nao*gamma_Nao +\
        ...
        math.exp(F*V/(Rgas*T)))
    i_CaL_K = PK*(Fx_ICaL_jct*fCa_jct + Fx_ICaL_SL*fCa_SL)*(-Ko*gamma_Ko +\
        Ki*gamma_Ki*math.exp(F*V/(Rgas*T)))*temp/(-1 +\
        math.exp(F*V/(Rgas*T)))
    i_CaL = i_CaL_Ca_SL + i_CaL_Na_jct + i_CaL_Ca_jct + i_CaL_Na_SL + i_CaL_K

    # Expressions for the Na buffer component
    dNa_jct_buf = kon*(Bmax_jct - Na_jct_buf)*Na_jct - koff*Na_jct_buf
    dNa_SL_buf = -koff*Na_SL_buf + kon*(-Na_SL_buf + Bmax_SL)*Na_SL
    values[24] = dNa_jct_buf
    values[25] = dNa_SL_buf
    values[26] = -Cm*(i_Na_jct + i_CaL_Na_jct + 3*i_NaK_jct + i_Nab_jct +\
        3*i_NaCa_jct)/(F*Vol_jct) - dNa_jct_buf - J_Na_jct_SL/Vol_jct
    #print values[26] , \
    #    i_NaK_jct 
    values[27] = -dNa_SL_buf - Cm*(3*i_NaCa_SL + i_Na_SL + i_CaL_Na_SL +\
        i_Nab_SL + 3*i_NaK_SL)/(F*Vol_SL) + (-J_Na_SL_myo +\
        J_Na_jct_SL)/Vol_SL
    ...
    dCa_SLB_SL = kon_SL*(-Ca_SLB_SL + Bmax_SLB_SL*Vol_myo/Vol_SL)*Ca_SL -\
        koff_SLB*Ca_SLB_SL
    dCa_SLB_jct = -koff_SLB*Ca_SLB_jct +\
        kon_SL*(0.1*Bmax_SLB_jct*Vol_myo/Vol_jct - Ca_SLB_jct)*Ca_jct
    dCa_SLHigh_SL = -koff_SLHigh*Ca_SLHigh_SL +\
        kon_SL*(Bmax_SLHigh_SL*Vol_myo/Vol_SL - Ca_SLHigh_SL)*Ca_SL
    dCa_SLHigh_jct = kon_SL*(0.1*Bmax_SLHigh_jct*Vol_myo/Vol_jct -\
        Ca_SLHigh_jct)*Ca_jct - koff_SLHigh*Ca_SLHigh_jct
    values[30] = dCa_SLB_SL
    values[31] = dCa_SLB_jct
    values[32] = dCa_SLHigh_SL
    values[33] = dCa_SLHigh_jct
    dCa_jct_tot_bound = dCa_SLHigh_jct + dCa_SLB_jct
    dCa_SL_tot_bound = dCa_SLB_SL + dCa_SLHigh_SL
    i_Ca_jct_tot = i_Cab_jct + i_CaL_Ca_jct + i_Cap_jct - 2*i_NaCa_jct
    i_Ca_SL_tot = i_Cap_SL + i_CaL_Ca_SL - 2*i_NaCa_SL + i_Cab_SL
    values[34] = -Vol_myo*j_leak_SR/Vol_SR - dCalsequestrin - j_rel_SR +\
        j_pump_SR
    values[35] = Vol_myo*j_leak_SR/Vol_jct + Vol_SR*j_rel_SR/Vol_jct -\
        Cm*i_Ca_jct_tot/(2*F*Vol_jct) - J_Ca_jct_SL/Vol_jct -\
        dCa_jct_tot_bound
    values[36] = (J_Ca_jct_SL - J_Ca_SL_myo)/Vol_SL - dCa_SL_tot_bound -\
    ...
    values[38] = -i_NaCa - i_Clb - i_Cap - i_tos - i_Cl_Ca - i_Na - i_tof -\
        i_Stim - i_Ks - i_Nab - i_CaL - i_Cab - i_Kr - i_K1 - i_Kp - i_NaK
...
def monitor(states, t, parameters, monitored=None):
    ...
    # Expressions for the Reversal potentials component
    monitored[110] = Rgas*T*math.log(Nao/Na_jct)/F
    monitored[111] = Rgas*T*math.log(Nao/Na_SL)/F
    monitored[112] = Rgas*T*math.log(Cao/Ca_jct)/(2*F)
    ...
    monitored[6] = Fx_Na_jct*G_INa*(V - monitored[110])*monitored[5]
    ...
    # Expressions for the INab component
    monitored[15] = Fx_NaBk_jct*G_NaBk*(V - monitored[110])
    ...
    monitored[19] = 1.0/(1 + 0.0365*math.exp(-F*V/(Rgas*T))*monitored[18] +\
        0.1245*math.exp(-0.1*F*V/(Rgas*T)))
    monitored[20] = Fx_NaK_jct*I_NaK_max*Ko*monitored[19]/((1 +\
        math.pow(Km_Nai/Na_jct, H_NaK))*(Km_Ko + Ko))
    ...
    # Expressions for the IKs component
    monitored[28] = 3 - math.log(Ca_jct)
    ...
    monitored[33] = Fx_Ks_jct*(Xs*Xs)*(V - monitored[32])*monitored[30]
    ...
    # Expressions for the ICl Ca component
    monitored[51] = G_Cl*(-monitored[115] + V)*(Fx_Cl_jct/(1 +\
        Kd_ClCa/Ca_jct) + Fx_Cl_SL/(1 + Kd_ClCa/Ca_SL))

    # Expressions for the IClb component
    monitored[52] = G_ClBk*(-monitored[115] + V)

    # Expressions for the d gate component
    monitored[61] = 1.0/(1 + 0.0892185174093*math.exp(-V/6.))
    monitored[62] = (1 -\
        0.0892185174093*math.exp(-V/6.))*monitored[61]/(0.5075 + 0.035*V)
    monitored[135] = (monitored[61] - d)/monitored[62]

    # Expressions for the f gate component
    monitored[63] = 0.6/(1 + math.exp(5/2. - V/20.)) + 1.0/(1 +\
        16964.681259*math.exp(0.277777777778*V))
    monitored[64] = 1.0/(0.02 + 0.0197*math.exp(-((0.48865 +\
        0.0337*V)*(0.48865 + 0.0337*V))))
    monitored[136] = (monitored[63] - f)/monitored[64]

    # Expressions for the FCa gate component
    monitored[65] = 1 - fCaB_SL
    monitored[66] = 1 - fCaB_jct
    monitored[137] = -0.0119*fCaB_SL + 1.7*(1 - fCaB_SL)*Ca_SL
    monitored[138] = -0.0119*fCaB_jct + 1.7*(1 - fCaB_jct)*Ca_jct

    # Expressions for the INaCa component
    monitored[67] = (-math.pow(Nao, HNa)*Ca_jct*math.exp(F*(-1 +\
        eta)*V/(Rgas*T)) + Cao*math.pow(Na_jct,\
    ...
    monitored[71] = 1.0/(1 + (Kd_act*Kd_act*Kd_act)/(Ca_jct*Ca_jct*Ca_jct))
    monitored[72] =\
        Fx_NCX_jct*V_max_INaCa*monitored[67]*monitored[69]*monitored[71]/(math.pow(Nao,\
        HNa)*Ca_jct + Cao*math.pow(Na_jct, HNa) + K_mCai*math.pow(Nao,\
        HNa)*(1 + math.pow(Na_jct/K_mNai, HNa)) + math.pow(K_mNao, HNa)*(1 +\
        Ca_jct/K_mCai)*Ca_jct + K_mCao*math.pow(Na_jct, HNa))
    monitored[73] =\
    ...
    monitored[76] = Fx_SLCaP_jct*V_maxAF*monitored[75]/(1 +\
        math.pow(Km/Ca_jct, H_ICap))
    monitored[77] = Fx_SLCaP_SL*V_maxAF*monitored[75]/(1 + math.pow(Km/Ca_SL,\
        H_ICap))
    monitored[78] = monitored[77] + monitored[76]

    # Expressions for the ICab component
    monitored[79] = Fx_CaBk_jct*G_CaBk*(V - monitored[112])
    ...
    monitored[139] = -(Ca_jct*Ca_jct)*R*monitored[83] + kim*monitored[85] +\
        kom*O - Ca_jct*R*monitored[84]
    monitored[140] = kim*I + (Ca_jct*Ca_jct)*R*monitored[83] -\
        Ca_jct*O*monitored[84] - kom*O
    monitored[141] = (Ca_jct*Ca_jct)*monitored[83]*monitored[85] - kim*I +\
        Ca_jct*O*monitored[84] - kom*I
    monitored[86] = ks*(Ca_SR - Ca_jct)*O

    # Expressions for the Jleak SR component
    monitored[87] = KSRleak*(Ca_SR - Ca_jct)
    ...
    # Expressions for the Ion diffusion component
    monitored[121] = -1.8313e-14*Na_SL + 1.8313e-14*Na_jct
    monitored[122] = 1.6386e-12*Na_SL - 1.6386e-12*Nai
    monitored[123] = 8.2413e-13*Ca_jct - 8.2413e-13*Ca_SL
    ...
    monitored[55] = 4*Fx_ICaL_jct*PCa*(-Cao*gamma_Cao +\
        gamma_Cai*Ca_jct*math.exp(2*F*V/(Rgas*T)))*monitored[54]*monitored[66]/(-1 +\
        math.exp(2*F*V/(Rgas*T)))
    monitored[56] = Fx_ICaL_jct*PNa*(-Nao*gamma_Nao +\
        gamma_Nai*Na_jct*math.exp(F*V/(Rgas*T)))*monitored[54]*monitored[66]/(-1 +\
        math.exp(F*V/(Rgas*T)))
    monitored[57] =\
        4*Fx_ICaL_SL*PCa*(gamma_Cai*Ca_SL*math.exp(2*F*V/(Rgas*T)) -\
        Cao*gamma_Cao)*monitored[54]*monitored[65]/(-1 +\
        math.exp(2*F*V/(Rgas*T)))
    monitored[58] = Fx_ICaL_SL*PNa*(-Nao*gamma_Nao +\
        gamma_Nai*Na_SL*math.exp(F*V/(Rgas*T)))*monitored[54]*monitored[65]/(-1 +\
        math.exp(F*V/(Rgas*T)))
    monitored[59] = PK*(Fx_ICaL_jct*monitored[66] +\
        Fx_ICaL_SL*monitored[65])*(-Ko*gamma_Ko +\
        Ki*gamma_Ki*math.exp(F*V/(Rgas*T)))*monitored[54]/(-1 +\
        math.exp(F*V/(Rgas*T)))
    monitored[60] = monitored[59] + monitored[56] + monitored[55] +\
        monitored[57] + monitored[58]

    # Expressions for the Na buffer component
    monitored[107] = kon*(Bmax_jct - Na_jct_buf)*Na_jct - koff*Na_jct_buf
    monitored[108] = -koff*Na_SL_buf + kon*(-Na_SL_buf + Bmax_SL)*Na_SL
    monitored[149] = monitored[107]
    monitored[150] = monitored[108]
    monitored[151] = -Cm*(3*monitored[72] + monitored[56] + 3*monitored[20] +\
        monitored[6] + monitored[15])/(F*monitored[3]) -\
        monitored[121]/monitored[3] - monitored[107]
    monitored[152] = (monitored[121] - monitored[122])/monitored[2] -\
        monitored[108] - Cm*(monitored[16] + 3*monitored[21] +\
        3*monitored[73] + monitored[58] + monitored[7])/(F*monitored[2])
    ...
    monitored[92] = kon_SL*(0.1*Bmax_SLB_jct*monitored[4]/monitored[3] -\
        Ca_SLB_jct)*Ca_jct - koff_SLB*Ca_SLB_jct
    monitored[93] = -koff_SLHigh*Ca_SLHigh_SL +\
        kon_SL*(Bmax_SLHigh_SL*monitored[4]/monitored[2] -\
        Ca_SLHigh_SL)*Ca_SL
    monitored[94] = kon_SL*(0.1*Bmax_SLHigh_jct*monitored[4]/monitored[3] -\
        Ca_SLHigh_jct)*Ca_jct - koff_SLHigh*Ca_SLHigh_jct
    monitored[155] = monitored[91]
    monitored[156] = monitored[92]
    monitored[157] = monitored[93]
    monitored[158] = monitored[94]
    monitored[95] = monitored[94] + monitored[92]
    monitored[96] = monitored[93] + monitored[91]
    monitored[97] = monitored[79] + monitored[55] - 2*monitored[72] +\
        monitored[76]
    monitored[98] = monitored[80] + monitored[77] + monitored[57] -\
        2*monitored[73]
    monitored[159] = -monitored[4]*monitored[87]/monitored[1] - monitored[86]\
        + monitored[89] - monitored[90]
    monitored[160] = monitored[1]*monitored[86]/monitored[3] -\
        monitored[123]/monitored[3] + monitored[4]*monitored[87]/monitored[3]\
        - monitored[95] - Cm*monitored[97]/(2*F*monitored[3])
    ...
    monitored[109] = (-stim_amplitude if\
        ...
        stim_start else 0)
    monitored[163] = -monitored[22] - monitored[78] - monitored[109] -\
        monitored[17] - monitored[60] - monitored[51] - monitored[74] -\
        monitored[8] - monitored[52] - monitored[81] - monitored[24] -\
        monitored[46] - monitored[117] - monitored[39] - monitored[35] -\
        monitored[38]
